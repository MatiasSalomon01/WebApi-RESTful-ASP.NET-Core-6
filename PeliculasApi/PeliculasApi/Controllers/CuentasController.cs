...
namespace PeliculasAPI.Controllers
{
    ...
    public class CuentasController : CustomBaseController
    {
        ...
        public async Task<IActionResult> Get([FromQuery] PaginacionDTO paginationDTO)
        {
            var queryable = context.Users.AsQueryable();
            queryable = queryable.OrderBy(x => x.Email);
            return await GetAllWithFilters<IdentityUser, UsuarioDTO>(paginationDTO);
        }
        ...
        [HttpPost("AsignarRol")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Admin")]
        public async Task<IActionResult> AsignarRol(EditarRolDTO editarRolDTO)
        {
